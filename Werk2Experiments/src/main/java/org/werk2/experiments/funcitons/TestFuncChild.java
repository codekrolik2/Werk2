...
public class TestFuncChild extends TestFunc {
	@WerkFunction
	public static int func1(@In int i, @In char c, @In ArrayList<Boolean> lst1, @Out OutParam<Map<String, List<Integer>>> mapx) {
